...
shape. Uses the same 1%/0.99% buffer vanguard/core/classifier.py already uses for
...
TRIGGER_BUFFER = 1.01      # matches vanguard/core/classifier.py:37 (call-side breakout)
