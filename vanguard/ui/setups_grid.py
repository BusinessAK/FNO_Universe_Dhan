...
from vanguard.config.setup_registry import SETUP_REGISTRY
from vanguard.core.config import INDEX_SYMBOLS as _INDEX_SYMBOLS
from vanguard.ui.cards import format_score, render_html
