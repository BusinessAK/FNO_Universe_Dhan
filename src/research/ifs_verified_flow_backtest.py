...
Mirrors src/research/flip_backtester.py's methodology (forward-return
...
Usage:
    python3 src/research/ifs_verified_flow_backtest.py [--db PATH] [--out DIR]
"""
...
from src.intelligence import InstitutionalIntelligence  # noqa: E402
from src.research.flip_backtester import attach_forward  # noqa: E402
